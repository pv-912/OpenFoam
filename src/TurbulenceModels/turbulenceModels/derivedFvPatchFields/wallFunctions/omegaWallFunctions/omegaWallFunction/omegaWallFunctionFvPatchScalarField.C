...
This file was modified by CFD support - TCFD - inconsistency with the main .build
...
// New implementation: https://github.com/OpenFOAM/OpenFOAM-dev/commit/4331b98735a6ccaf327dec2747ac6638cb81deca
...
// Older implementation - consistent with TCFD1802
        const scalar omegaVis = 6*nuw[facei]/(beta1_*sqr(y[facei]));
